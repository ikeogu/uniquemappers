                              ...
                              <div class="card">
                                  ...
                                  <div class="content">
                                      <form action="addimage.php" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="row">   
                                              <div class="col-md-4 col-lg-6 col-sm-8">
                                                  <div class="form-group">
                                          ...
                                          <div class="row">
                                                  ...
                                                  <div class="col-lg-4 col-md-4 col-sm-8">
                                                      <div class="form-group">
                                                      <button type="submit" class="btn btn-info btn-fill pull-right" name="create" >UpLoad</button>
                                                  </div>
                                                  </div>
                                          </div>
                                      </form>
