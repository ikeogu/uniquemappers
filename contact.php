...
if($SMTPmail) {
	$smtpServer = "smtp.checkam.info"; //Set the hostname of the mail server
	$smtpPort = 587; //Set the SMTP port number - likely to be 25, 465 or 587		
	$smtpAuth = true; //Whether to use SMTP authentication
	//$smtpSecure = "tls"; //Set SSL or TLS
	$smtpUsername = "uniquemappersteam@gmail.com "; //Username to use for SMTP authentication
	$smtpPassword = "uniquemappersteam"; //Password to use for SMTP authentication
}
...
if(isset($_POST['submit'])):
	...
	$to = 'uniquemappersteam@gmail.com';
		...
		if($SMTPmail) {
			...
			*/
			...
			if (!$mail->send()) {
				...
				$succMsg = "Mailed with success through SMTP.";
			}
    ...
    <div class="wrapper">
        <div id="main" style="padding:50px 0 0 0;">
            ...
            <form id="contact-form" action="contact.php" method="POST">
                ...
                <h3>Mail to UniqueMappersTeam</h3>
